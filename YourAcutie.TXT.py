...
password = "pASS?0wRd"
userInput = input("OH NO!!! cheak your files\n")
...
if userInput == password:
	...
	print("Your files are decrypted!")
  	print("                 lxOKNWWWWWWNK0xl")
  	print("              dKWMMMMMMMMMMMMMMMMN0d")
  	print("            kNMMMMMMMMMMMMMMMMMMMMMMNk")
  	print("          oXMMMMMMMMMMMMMMMMMMMMMMMMMMXo")
  	print("         dWMMMMMKxokXMMMMMMMMXkoxKWMMMMWd")
  	print("        oNMMMMMK    cXMMMMMMXc    KMMMMMNo")
  	print("        KMMMMMMNd   xNMMMMMMNx   oXMMMMMMK")
  	print("       cNMMMMMMMWNXNWMMMMMMMMWNXNWMMMMMMMNc")
  	print("       lNMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMNl")
  	print("        XMMMMMWMMMMMMMMMMMMMMMMMMMWWMMMMMX")
  	print("        kMMMWOcl0WMMMMMMMMMMMMMMW0lcOMMMMk")
  	print("         KMMM0   oKWMMMMMMMMMMWKo   0MMMK")
  	print("          0MMMNx    dk0KXXK0kd    xXMMW0")
  	print("           xNMMMNOo            oONMMMNx")
  	print("             xXMMMMWX0OkkkkO0XWMMMWXx")
  	print("                ckKNMMMMMMMMMMMWNKkc")
  	print("                    ldxxkkxxdl")
else:
